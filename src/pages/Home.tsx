  ...
  return (
    <>
      ...
      <section className="w-full py-20 bg-cream text-charcoal">
        <motion.div
          className="container mx-auto flex flex-col-reverse lg:flex-row items-center px-6 lg:px-0"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="w-full lg:w-1/2 text-center lg:text-left mt-8 lg:mt-0">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-6 mt-10">
              <a
                href="#quote"
                className="bg-tan text-white font-semibold py-3 px-8 rounded-full shadow-md hover:bg-tan-dark transform transition"
              >
                Get a Quote
              </a>
              <a
                href={bookingURL}
                className="border-2 border-tan text-tan font-semibold py-3 px-8 rounded-full shadow-md hover:bg-tan hover:text-white transform transition"
              >
                Book Now
              </a>
            </div>
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <motion.img
              ...
              className="object-contain shadow-2xl rounded-xl w-full max-w-2xl"
              initial={{ scale: 0.8 }}
              animate={{ scale: 1 }}
              transition={{ duration: 0.8 }}
            />
      ...
      <section className="py-20 text-charcoal">
        <div className="container mx-auto px-6">
          ...
          {/* Animated Indicator under heading */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="flex flex-col items-center text-center p-8 bg-tan rounded-2xl shadow hover:shadow-lg hover:bg-tan-dark transition"
              >
                <service.icon className="text-cream text-6xl mb-4" />
                <h3 className="text-2xl font-semibold mb-2 text-charcoal">
                  {service.title}
                </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <motion.blockquote
                ...
                className="bg-tan p-8 rounded-2xl shadow hover:shadow-lg hover:bg-tan-dark transition"
              >
      ...
      <section className="py-16 bg-tan text-white text-center">
        <div className="container mx-auto px-6">
          ...
          <motion.a
            href={bookingURL}
            className="inline-block bg-cream text-charcoal font-semibold py-3 px-8 rounded-full shadow hover:bg-tan-dark transition"
